...
/**
 * Controller untuk halaman Template Desain.
 * Menampilkan koleksi template desain yang tersedia untuk tim design.
 */
public class TemplateDesainPaneController implements Initializable {

    @FXML
    private FlowPane templateContainer;

    private final List<DesignTemplate> templates = new ArrayList<>();
    ...
    private VBox createTemplateCard(DesignTemplate item) {
        ...
        card.setStyle(
                "-fx-background-color: white; -fx-border-color: #eeeeee; -fx-border-radius: 8; -fx-background-radius: 8; -fx-effect: dropshadow(gaussian, rgba(0,0,0,0.02), 5, 0, 0, 1);");
        ...
        icon.setContent(
                "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1.41 16.09V20h-2.67v-1.93c-1.71-.36-3.16-1.54-3.92-3.11l1.73-.72c.43.9 1.25 1.57 2.19 1.77V14h2.67v2.1c1.71.36 3.16 1.54 3.92 3.11l-1.73.72c-.43-.9-1.25-1.57-2.19-1.77z");
        ...
        card.setOnMouseEntered(e -> card.setStyle(
                "-fx-background-color: white; -fx-border-color: #d0d0d0; -fx-border-radius: 8; -fx-background-radius: 8; -fx-effect: dropshadow(gaussian, rgba(0,0,0,0.08), 8, 0, 0, 2); -fx-cursor: hand;"));
